...
- Today the app seeds one example matrix ("Karli — broad careers") and drops the
...
**D3. Seeded example — keep, change, or remove?** The "Karli" data is personal/
specific. Options: keep as the demo, replace with a neutral generic example
